...
1. If you haven’t already, sign up for the [PHG affiliate program](https://itunes.phgconsole.performancehorizon.com/login/itunes) (instructions on how to sign up can be found on [our site](http://help.geni.us/support/solutions/articles/3000027495-itunes-phg-affiliate-program-guide)).
1. Once approved, jump into your Geniuslink dashboard and click on the “Affiliate” tab. Then, click “Connect an affiliate program” button and paste in your PHG affiliate token.
...
1.     Log into your Geniuslink Dashboard, and navigate to the Account Tab.
...
1. Add your PHG affiliate token to your Geniuslink dashboard.  Instructions on how to do this can be found [here](http://help.geni.us/support/solutions/articles/3000034945-adding-your-phg-affiliate-token-to-geniuslink).
...
1. **After:** When you install the iTunes Link Engine, we automatically globalize and affiliate all iTunes links on your WordPress site.
...
1. **The Results:** Each user gets sent to the correct item in their local store. This is an example of a user from Germany clicking your link. They’re sent to [iTunes Germany](https://itunes.apple.com/de/album/id14920526?i=14920531) with your affiliate token attached.
